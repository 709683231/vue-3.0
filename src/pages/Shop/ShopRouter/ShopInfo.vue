<template>
  <div class="shop-info" ref="myScroll">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity" v-for="(support,index) in info.supports" :key="index">
          <div class="activity-item activity-green" :class="classColor[support.type]">
      ...
      <section class="section">
        ...
        <div class="pic-wrapper" ref="imgScroll">
          <ul class="pic-list" >
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data(){
      return {
        classColor:["activity-green","activity-red","activity-orange"]
      }
    },
    mounted(){
